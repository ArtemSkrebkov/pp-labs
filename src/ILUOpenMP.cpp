...
void ILUOpenMP::Compute(SparseMatrixCRS &A, SparseMatrixCRS &M, int p)
{
	...
	L.MultiplyOpenMP(L, UT, M);
}

bool ILUOpenMP::isCorrectMatrix(SparseMatrixCRS &A)
{
	bool result = true;
...
bool ILUOpenMP::CheckAinM(SparseMatrixCRS &A, SparseMatrixCRS &M)
{
	bool result = true;
...
bool ILUOpenMP::CheckInverse(SparseMatrixCRS &A, SparseMatrixCRS &M)
{
...
void ILUTBB::Compute(SparseMatrixCRS &A, SparseMatrixCRS &M, int p)
{
	SparseMatrixCRS L, U(A);
	L.mN = A.mN;
	L.mValues.reserve(A.mNZ);
	...
	L.MultiplyTBB(L, UT, M);
}

bool ILUTBB::isCorrectMatrix(SparseMatrixCRS &A)
{
	bool result = true;
...
bool ILUTBB::CheckAinM(SparseMatrixCRS &A, SparseMatrixCRS &M)
{
	bool result = true;
...
bool ILUTBB::CheckInverse(SparseMatrixCRS &A, SparseMatrixCRS &M)
{
...
void ILUCilk::Compute(SparseMatrixCRS &A, SparseMatrixCRS &M, int p)
{
	SparseMatrixCRS L, U(A);
	L.mN = A.mN;
	L.mValues.reserve(A.mNZ);
...
bool ILUCilk::isCorrectMatrix(SparseMatrixCRS &A)
{
	bool result = true;
...
bool ILUCilk::CheckAinM(SparseMatrixCRS &A, SparseMatrixCRS &M)
{
	bool result = true;
...
bool ILUCilk::CheckInverse(SparseMatrixCRS &A, SparseMatrixCRS &M)
{
